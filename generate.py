...
parser.add_argument('--file', '-f', default = 'diag2-4-from-omit', \
...
input_lang, output_lang, pairs = prepareData('diag1', args.file, False)

filename = './savedModel/two_sentences_' + args.time
